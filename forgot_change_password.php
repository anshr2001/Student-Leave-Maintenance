  ...
  else
  {
    ...
    if(mysqli_num_rows($result) === 1)
    {
        ...
        if(($row['studentid'] === $studentid) && ($row['studentroll'] === $studentroll))
        {
          ...
          $stmt = $conn1->prepare("UPDATE studentdetails SET studentpassword = '$studentpassword' WHERE studentroll = '$studentroll' AND studentid = '$studentid' "); 
    ...
    {
      echo "<h2> Student Roll number and Username doesn't Match </h2>";
    }
